...
<script src="{{ asset($atv_theme_pkg_prefix.'public/themes/'.$theme.'/js/theme.js')}}"></script>
<script src="{{ asset($atv_theme_pkg_prefix.'public/themes/'.$theme.'/js/common.js')}}"></script>
